...
public class GRect implements GShape, Comparable<com.drawing.GCRect> {
    // Comparable<GCRect>
    ...
    GRect(final GL2 gl, float vertex2f[], float speedX, float speedY) {
    ...
    public void render(final GL2 gl) {
        ...
        // move the land piece
        vertex2f[3] = vertex2f[3] + this.speedX;
        vertex2f[4] = vertex2f[4] + this.speedY;
    ...
    public int compareTo(com.drawing.GCRect paramRect) {
